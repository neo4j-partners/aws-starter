...
uv run local-test all orchestrator-agent    # Build, run, test all-in-one
uv run local-test build orchestrator-agent  # Build Docker image
uv run local-test run orchestrator-agent    # Start container
uv run local-test test orchestrator-agent   # Send test request
uv run local-test logs orchestrator-agent   # View container logs
uv run local-test stop orchestrator-agent   # Stop container
