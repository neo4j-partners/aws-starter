...
Review date: 2026-05-17. Scope: `infra_samples/simple-oauth-gateway`,
...
from `infra_samples/` because the finalized `neo4j-agentcore-mcp-server`
stack and `fleet-agent-demo/agent` already cover those patterns.
