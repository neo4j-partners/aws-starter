...
2. [AWS Bedrock AgentCore Platform Overview](#aws-bedrock-agentcore-platform-overview)
3. [Integration Point 1: Neo4j MCP Server on AgentCore](#integration-point-1-neo4j-mcp-server-on-agentcore)
4. [Integration Point 2: Neo4j Agent Memory](#integration-point-2-neo4j-agent-memory)
5. [Integration Point 3: Neo4j GraphRAG Library](#integration-point-3-neo4j-graphrag-library)
6. [Integration Point 4: Context Graphs for Agentic AI](#integration-point-4-context-graphs-for-agentic-ai)
7. [Integration Point 5: AgentCore Memory + Neo4j Hybrid](#integration-point-5-agentcore-memory--neo4j-hybrid)
8. [Integration Point 6: Strands Agents SDK](#integration-point-6-strands-agents-sdk)
9. [Integration Point 7: Multi-Agent Orchestration](#integration-point-7-multi-agent-orchestration)
10. [Integration Point 8: Bedrock Knowledge Bases GraphRAG](#integration-point-8-bedrock-knowledge-bases-graphrag)
11. [Integration Point 9: SageMaker Unified Studio](#integration-point-9-sagemaker-unified-studio)
12. [Integration Point 10: Databricks on AWS](#integration-point-10-databricks-on-aws)
13. [Integration Point 11: Neo4j Aura on AWS](#integration-point-11-neo4j-aura-on-aws)
14. [Integration Point 12: Aura Agent with Amazon Bedrock Embeddings](#integration-point-12-aura-agent-with-amazon-bedrock-embeddings)
15. [Innovative Ideas & Future Directions](#innovative-ideas--future-directions)
16. [Integration Matrix](#integration-matrix)
...
Neo4j has deep and expanding integration potential with AWS, particularly through Amazon Bedrock AgentCore. This report identifies **11 concrete integration points** spanning MCP servers, agent memory, GraphRAG pipelines, multi-agent orchestration, and managed infrastructure. The combination of Neo4j's graph-native capabilities with AWS's agentic AI platform creates a compelling stack for building production-grade AI agents that reason over connected data.
...
## AWS Bedrock AgentCore Platform Overview
...
## Integration Point 1: Neo4j MCP Server on AgentCore
...
## Integration Point 2: Neo4j Agent Memory
...
## Integration Point 3: Neo4j GraphRAG Library
...
## Integration Point 4: Context Graphs for Agentic AI

**AWS Services**: Amazon Bedrock AgentCore Memory (complementary), AgentCore Runtime (hosting)

### What Is a Context Graph?

A **Context Graph** is Neo4j's term for a knowledge graph specifically designed to provide rich, connected context to AI agents. Unlike flat document stores or key-value memory, a context graph maintains:

1. **Entities** with types, properties, and descriptions
2. **Relationships** between entities with types and confidence scores
3. **Temporal context** — when things were learned, when they happened
4. **Provenance** — which conversation, document, or interaction produced each fact
5. **Multi-hop paths** — the ability to traverse from one entity through several relationships to discover non-obvious connections
...
## Integration Point 5: AgentCore Memory + Neo4j Hybrid
...
## Integration Point 6: Strands Agents SDK
...
## Integration Point 7: Multi-Agent Orchestration
...
## Integration Point 8: Bedrock Knowledge Bases GraphRAG
...
## Integration Point 9: SageMaker Unified Studio
...
## Integration Point 10: Databricks on AWS

**AWS Services**: Databricks on AWS, Unity Catalog, Amazon Bedrock AgentCore

### Current Integration (This Repository)

This repository demonstrates Databricks integration:
- **Unity Catalog HTTP connection** to the Neo4j MCP server running on AgentCore
- **LangGraph agent deployment** within Databricks notebooks
- Secrets management via Databricks secret scopes, populated from MCP server credentials

### Integration Patterns

1. **Databricks Notebooks** — Build and query knowledge graphs using Neo4j GraphRAG within the Databricks workspace
2. **Unity Catalog** — Register Neo4j MCP connections as managed catalog resources for discoverability and governance
3. **MLflow** — Track GraphRAG experiments with Neo4j retrieval metrics alongside model training metrics
4. **Apache Spark** — Large-scale graph data processing using the Neo4j Spark Connector for bulk data movement
5. **Mosaic AI** — Use Neo4j as a tool provider for Databricks' AI agent framework

---

## Integration Point 11: Neo4j Aura on AWS

**AWS Services**: AWS Marketplace, Amazon VPC (peering), AWS PrivateLink

### Managed Neo4j on AWS

**Neo4j Aura** is Neo4j's fully managed cloud database, available on AWS:

- **Aura Professional** — Available in AWS Marketplace (part of the Neo4j-AWS Strategic Collaboration Agreement, signed November 2023)
- **Aura Business Critical** — Enterprise-grade with advanced security and dedicated infrastructure
- **Aura Graph Analytics** — Neo4j Graph Data Science algorithms in the cloud
- **Regions** — Multiple AWS regions supported
- **Private connectivity** — VPC peering and private endpoints available for secure network paths
- **Billing** — Pay through the AWS bill with consolidated billing via AWS Marketplace

### Neo4j Aura Agent (GA February 2026)

Neo4j launched **Aura Agent**, now generally available as of February 2026:
- Automated, ontology-driven agent construction from the AuraDB data schema
- Single-click deployment to a hosted, secure MCP Server
- Agentic GraphRAG with multi-hop graph reasoning
- Transparent chain-of-thought explainability
- Available as both MCP and REST endpoints
- Part of Neo4j's $100M investment in AI-native ventures (targeting 1,000+ startups)

### Integration Value

Neo4j Aura eliminates the operational burden of running Neo4j. Combined with AgentCore Runtime for agents and AgentCore Gateway for routing, the entire stack becomes fully managed services: AgentCore Runtime (managed by AWS) connects through AgentCore Gateway (managed by AWS) to Neo4j Aura (managed by Neo4j, billed through AWS Marketplace).

---

## Integration Point 12: Aura Agent with Amazon Bedrock Embeddings
...
| Databricks on AWS | **Implemented** | Medium | Medium | Databricks, Unity Catalog, AgentCore |
| Neo4j Aura on AWS | **GA** | Low | High | AWS Marketplace, Amazon VPC |
...
- [Databricks Samples](./databrick_samples/)
