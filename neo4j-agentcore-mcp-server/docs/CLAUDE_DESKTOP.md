...
|-------------|-------------|---------|
| `<MCP_ENDPOINT_URL>` | The full URL-encoded MCP endpoint | `https://bedrock-agentcore.us-east-1.amazonaws.com/runtimes/arn%3Aaws%3A.../invocations?qualifier=DEFAULT` |
