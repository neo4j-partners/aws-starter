...
def load_credentials() -> dict:
    ...
    if not CREDENTIALS_FILE.exists():
        ...
        print()
        print("Run './deploy.py credentials' to generate it")
        sys.exit(1)
...
def get_credentials() -> dict:
    ...
    if not check_token_expiry(credentials):
        ...
        print()
        print("Run './deploy.py credentials' to refresh")
        sys.exit(1)
...
def cmd_token():
    ...
    if check_token_expiry(credentials):
        ...
        print("Status: EXPIRED - run './deploy.py credentials' to refresh")
        sys.exit(1)
...
Auth:   Uses .mcp-credentials.json (generated by ./deploy.py credentials)
